...
public class KitsCommand implements CommandExecutor
{
    ...
    public JSONChatExtra create(final Player player, final Kits kit) {
        ...
        extra.setHoverEvent(JSONChatHoverEventType.SHOW_TEXT, String.valueOf(kit.getName()) + "\n" + "\n" + "§a§nClique para selecionar!");
    ...
    public void sendKits(final Player player) {
        ...
        if (q < 19) {
            message = new JSONChatMessage("§fKits que voc\u00ea possui (§c" + q + "§7/§a" + Kits.values().length + "§f): ", (JSONChatColor)null, (List)null);
        }
        else {
            message = new JSONChatMessage("§fKits que voc\u00ea possui (§a" + q + "§7/§a" + Kits.values().length + "§f): ", (JSONChatColor)null, (List)null);
        }
        final JSONChatExtra membro = new JSONChatExtra("§e" + Kits.NENHUM.getName());
        membro.setHoverEvent(JSONChatHoverEventType.SHOW_TEXT, "§e" + Kits.NENHUM.getName() + "\n" + "\n" + "§a§nClique para selecionar!");
