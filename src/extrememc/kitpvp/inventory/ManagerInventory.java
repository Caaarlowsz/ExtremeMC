...
public class ManagerInventory {
	...
	public static void sendItens(final Player player) {
		...
		inventory.setItem(3, ItemBuilder.criarItem(Material.CHEST, ManagerInventory.kitSelector,
				"§7Veja todas as suas habilidades."));
		inventory.setItem(5, ItemBuilder.criarItem(Material.PAPER, ManagerInventory.warpSelector,
				"§7Veja as warps disponivel do servidor."));
