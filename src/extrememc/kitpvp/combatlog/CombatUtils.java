...
public class CombatUtils implements Listener
{
    ...
    public void entityDamageByEntity(final EntityDamageByEntityEvent event) {
        ...
        if (WarpsAPI.isInWarp(hitted, WarpsAPI.Warps.ONEVSONE) || WarpsAPI.isInWarp(hitter, WarpsAPI.Warps.ONEVSONE) || ProtectionManager.hasProtection(hitted) || ProtectionManager.hasProtection(hitter)) {
            return;
        }
    ...
    public void playerQuitEvent(final PlayerQuitEvent event) {
        if (inCombat(event.getPlayer())) {
            ...
            if (Gladiator.fighting.containsKey(player.getName())) {
                final Player killer = Bukkit.getServer().getPlayer((String)Gladiator.fighting.get(player.getName()));
                ...
                if (jogador2.getStatusKitPvP().getStreak() % 5 == 0) {
                    Bukkit.broadcastMessage("§c§lKILLSTREAK §fO jogador " + player.getName() + " perdeu seu §4§lSTREAK §fde " + Strings.primaryColor + jogador2.getStatusKitPvP().getStreak() + " §fpara " + killer.getName());
                }
                ...
                if (percentKillerXP == 12) {
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        ...
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +24 DoubleXP");
                    }
                    else {
                        jogador.getStatusGlobal().addXP(12);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +12 XP");
                    }
                }
                else if (percentKillerXP == 11) {
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(22);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +22 DoubleXP");
                    }
                    else {
                        jogador.getStatusGlobal().addXP(11);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +11 XP");
                    }
                }
                else if (percentKillerXP == 10) {
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(20);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +20 DoubleXP");
                    }
                    else {
                        jogador.getStatusGlobal().addXP(10);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +10 XP");
                    }
                }
                else if (percentKillerXP == 9) {
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(18);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +18 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        ...
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +16 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        ...
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +14 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(12);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +12 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(10);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +10 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(8);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +8 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(6);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +6 DoubleXP");
                    }
                    else {
                    ...
                    if (extrememc.common.Main.getInstance().getPermissions().isLight(killer)) {
                        jogador.getStatusGlobal().addXP(2);
                        killer.sendMessage("§a§lMATOU §fVoc\u00ea matou o jogador §a" + player.getName() + "§f. +2 DoubleXP");
                    }
                    else {
                ...
                if (jogador.getStatusKitPvP().getStreak() > jogador.getStatusKitPvP().getMaxStreak()) {
                    ...
                    Bukkit.broadcastMessage("§e§lMAXSTREAK §fO jogador " + killer.getName() + " est\u00e1 com o maior §a§lSTREAK §fdo servidor.");
                }
                ...
                new BukkitRunnable() {
                    public void run() {
                        if (jogador.getStatusKitPvP().getStreak() % 5 == 0) {
                            Bukkit.broadcastMessage("§e§lKILLSTREAK §fO jogador " + killer.getName() + " est\u00e1 com um §a§lSTREAK §fde " + Strings.primaryColor + jogador.getStatusKitPvP().getStreak());
                        }
                    }
