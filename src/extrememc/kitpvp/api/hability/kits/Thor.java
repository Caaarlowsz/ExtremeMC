...
public class Thor implements Listener
{
    ...
    public void ThorKit(final PlayerInteractEvent e) {
        ...
        if (p.getItemInHand().getType() == Material.WOOD_AXE && e.getAction() == Action.RIGHT_CLICK_BLOCK && KitAPI.hasKit(p, Kits.THOR)) {
            if (CooldownAPI.cooldown.containsKey(p.getName())) {
                ...
                final Location loc = p.getTargetBlock((HashSet)null, 70).getLocation();
