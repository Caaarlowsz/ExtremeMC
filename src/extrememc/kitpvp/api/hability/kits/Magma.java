...
public class Magma implements Listener
{
    ...
    public void damage(final EntityDamageEvent e) {
        if (e.getEntity() instanceof Player) {
            ...
            if (KitAPI.hasKit(p, Kits.MAGMA) && (e.getCause() == EntityDamageEvent.DamageCause.LAVA || e.getCause() == EntityDamageEvent.DamageCause.FIRE || e.getCause() == EntityDamageEvent.DamageCause.FIRE_TICK)) {
                e.setCancelled(true);
            }
        }
    }
