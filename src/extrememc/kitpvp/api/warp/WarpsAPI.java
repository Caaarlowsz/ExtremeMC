...
public class WarpsAPI implements Listener
{
    ...
    public WarpsAPI() {
        ...
        WarpsAPI.kWarps = (FileConfiguration)YamlConfiguration.loadConfiguration(WarpsAPI.fWarps);
    }
    ...
    public static void setWarpLocation(final Player p, final Warps warp) {
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".X", (Object)p.getLocation().getX());
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".Y", (Object)p.getLocation().getY());
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".Z", (Object)p.getLocation().getZ());
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".Pitch", (Object)p.getLocation().getPitch());
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".Yaw", (Object)p.getLocation().getYaw());
        WarpsAPI.kWarps.set("Warps." + warp.toString().toUpperCase() + ".World", (Object)p.getLocation().getWorld().getName());
        save();
    }
    
    public static void setWarpLocation(final Player p, final Locais local) {
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".X", (Object)p.getLocation().getX());
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".Y", (Object)p.getLocation().getY());
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".Z", (Object)p.getLocation().getZ());
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".Pitch", (Object)p.getLocation().getPitch());
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".Yaw", (Object)p.getLocation().getYaw());
        WarpsAPI.kWarps.set("Warps." + local.toString().toUpperCase() + ".World", (Object)p.getLocation().getWorld().getName());
        save();
    }
    ...
    public static void goToWarp(final Player p, final Warps warp) {
        if (WarpsAPI.kWarps.contains("Warps." + warp.toString().toUpperCase())) {
            ...
            final World World = Bukkit.getWorld(WarpsAPI.kWarps.getString("Warps." + warp.toString().toUpperCase() + ".World"));
            final Location loc = new Location(World, X, Y, Z, Yaw, Pitch);
            p.teleport(loc);
        }
        else {
            p.sendMessage("§3§lWARP §fA warp §c" + warp.name().toUpperCase() + " §fest\u00e1 em §c§lMANUTEN\u00c7\u00c3O§f.");
        }
    }
    ...
    public static void goToWarp(final Player p, final Locais local) {
        if (WarpsAPI.kWarps.contains("Warps." + local.toString().toUpperCase())) {
            ...
            final World World = Bukkit.getWorld(WarpsAPI.kWarps.getString("Warps." + local.toString().toUpperCase() + ".World"));
            final Location loc = new Location(World, X, Y, Z, Yaw, Pitch);
            p.teleport(loc);
        }
        else {
    ...
    public enum Locais
    {
        ONEVSONEPOS1("ONEVSONEPOS1", 0), 
        ONEVSONEPOS2("ONEVSONEPOS2", 1);
        
        private Locais(final String s, final int n) {
        }
    }
    ...
    public enum Warps
    {
        ...
        FPS("FPS", 2), 
        ONEVSONE("ONEVSONE", 3), 
        SCREENSHARE("SCREENSHARE", 4), 
        EVENTO("EVENTO", 5);
        
        private Warps(final String s, final int n) {
        }
    }
}
