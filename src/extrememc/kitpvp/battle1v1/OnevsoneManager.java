...
public class OnevsoneManager
{
    ...
    public static void startMatch(final Player player, final Player player_2) {
        ...
        for (int i = 0; i < 9; ++i) {
            player.getInventory().addItem(new ItemStack[] { create(Material.MUSHROOM_SOUP, "", (short)0) });
            player_2.getInventory().addItem(new ItemStack[] { create(Material.MUSHROOM_SOUP, "", (short)0) });
        }
        player.getInventory().setItem(0, ItemBuilder.criarItem(Material.DIAMOND_SWORD, "", Enchantment.DAMAGE_ALL, 1));
        player_2.getInventory().setItem(0, ItemBuilder.criarItem(Material.DIAMOND_SWORD, "", Enchantment.DAMAGE_ALL, 1));
        player.updateInventory();
