...
public class Scoreboarding {
	...
	private static FastOfflinePlayer getFastOfflinePlayer(final String string, final String teamname,
			final String suffix, final String prefix, final Scoreboard sb) {
	...
	private static void makeScore(final String string, final String teamname, final String suffix, final String prefix,
			final Scoreboard sb, final int integer) {
		Objective obj = null;
